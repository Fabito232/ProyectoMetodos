...
console.log("Utilización promedio del sistema:", calcularP(tasaLlegada, tasaServicio, numServidores));
console.log("Número promedio de clientes en la cola:", calcularLq(tasaLlegada, tasaServicio, numServidores));
console.log("Número promedio de clientes en el sistema:", calcularL(tasaLlegada, tasaServicio, numServidores));
console.log("Tiempo promedio en cola:", calcularWq(tasaLlegada, tasaServicio, numServidores));
console.log("Tiempo promedio transcurrido en el sistema:", calcularW(tasaLlegada, tasaServicio, numServidores));
console.log("Probabilidad de que un cliente tenga que esperar:", calcularPw(tasaLlegada, tasaServicio, numServidores));
